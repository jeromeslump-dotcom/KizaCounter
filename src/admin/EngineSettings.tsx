    ...
    <div className="grid grid-cols-[minmax(0,1fr)_minmax(150px,190px)_minmax(0,1fr)] items-center gap-3 border-b ui-divider py-4 last:border-b-0">
      <div className="min-w-0">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="ui-text-primary w-16 shrink-0 text-right text-xs font-black">
            {valueA} / 100
          </span>
        </div>
      </div>
      ...
      <div className="min-w-0 text-center">
        ...
        <div className="ui-text-muted mt-0.5 text-[10px] font-semibold">
          Budget maximum du module
        </div>
      </div>

      <div className="min-w-0">
        <div className="flex items-center gap-2">
          <span className="ui-text-primary w-16 shrink-0 text-xs font-black">
            {valueB} / 100
          </span>
          <input
    ...
    <div className="grid grid-cols-[minmax(0,1fr)_minmax(150px,190px)_minmax(0,1fr)] items-center gap-3 border-b ui-divider py-3 last:border-b-0">
      <div className="min-w-0">
        {hasA ? (
          ...
          <span className="ui-text-muted block text-center text-xs font-semibold">
            —
          </span>
        )}
      </div>
...
export default function EngineSettings({
    ...
    () => [
      {
        ...
        a: "specificHistoryPoints" as const,
        b: "specificHistoryPoints" as const,
      },
      {
        icon: "🧩",
        title: "Core4 historique",
        a: "core4Points" as const,
        b: "core4Points" as const,
      },
      {
        icon: "📊",
        title: "Winrate général",
        a: "generalWinRatePoints" as const,
        b: "generalWinRatePoints" as const,
      },
    ],
    []
  );
  ...
  const totalPointsB =
    ...
    settings.teamB.generalWinRatePoints;
