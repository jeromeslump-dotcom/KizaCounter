...
import { completeZones, METRICS, type TeamLabMode, zoneSummary } from "./teamLabData";
          ...
          <div className="ui-modal-header-inner">
            <div>
              ...
              <p className="ui-text-secondary mt-1 text-xs sm:text-sm">
                {mode === "combats" ? "Répartition réelle des combats enregistrés dans les 20 zones" : "Répartition réelle des formations enregistrées dans les 20 zones"}
              </p>
            </div>
