...
export default function useCombatSelection({
  ...
  function openCounterModal(enemyTeamIds: string[]) {
    ...
    // Remplacement complet et atomique de l'équipe active.
    setTeamIds([...ids]);
    setShowCounterModal(true);
  }

  function selectRecommendedTeam(ids: string[]) {
    // Une recommandation A/B doit toujours remplacer toute l'équipe.
    // On dédoublonne, élimine les ennemis et limite à 5 héros.
