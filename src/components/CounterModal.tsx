            ...
            <div className="mt-4 space-y-3">
              {recommendedTeam.length > 0 && (
                <button
                  ...
                  className="ui-recommendation-team"
                >
                  <div className="flex items-center justify-between gap-3">
                    <div className="min-w-0">
                      <div className="ui-text-primary text-sm font-bold">
                        Recommandation
                      </div>
                      <div className="ui-text-secondary mt-0.5 text-[11px]">
                        Cliquez pour utiliser cette équipe.
                      </div>
                    </div>
